...
def get_ever_info(html, fir_regex, sec_regex):
    fir_html = get_info(html, fir_regex, fetch_one=True)
    ever_infos = get_info(fir_html, sec_regex)
    return ever_infos
