...
# APP包名
APP_PACKAGE = 'com.one.tomato'

# 入口类名
APP_ACTIVITY = 'com.one.tomato.ui.StartUpActivity'
    ...
    def crawl(self):
        ...
        a = self.wait.until(
            EC.element_to_be_clickable(
                (By.ID, 'com.one.tomato:id/tv_count_down')))
        a.click()
        # 点击关闭公告
        b = self.wait.until(
            EC.element_to_be_clickable(
                (By.ID, 'com.one.tomato:id/iv_delete')))
        b.click()
        #点击进入直播页面
        c = self.wait.until(
            EC.element_to_be_clickable(
                (By.ID, 'com.one.tomato:id/ll_live')))
        c.click()

        c = self.wait.until(
            EC.element_to_be_clickable(
                (By.ID, 'com.one.tomato:id/siv_pic')))
        c.click()
